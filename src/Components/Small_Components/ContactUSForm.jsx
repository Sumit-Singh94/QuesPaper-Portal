        ...
        <div className="max-w-md mx-auto px-8 py-6 bg-gray-100 rounded-lg shadow-lg">
          ...
          <form onSubmit={handleSubmit}>
            <div className="mb-4">
              ...
              <input className="w-full px-4 py-2 bg-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-300 transition duration-300" placeholder="Enter your name" type="text" required />
            </div>
            <div className="mb-4">
